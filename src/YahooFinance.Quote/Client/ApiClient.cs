...
namespace YahooFinance.Quote.Client
{
        ...
        public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = YahooFinance.Quote.Client.Configuration.Default;
            RestClient = new RestClient("https://query1.finance.yahoo.com/v7/finance");
            RestClient.IgnoreResponseStatusCode = true;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://query1.finance.yahoo.com/v7/finance).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? YahooFinance.Quote.Client.Configuration.Default;
        ...
        public ApiClient(String basePath = "https://query1.finance.yahoo.com/v7/finance")
        {
